...
type MiniQLVisitor interface {
	...
	// Visit a parse tree produced by MiniQLParser#error.
	...
	// Visit a parse tree produced by MiniQLParser#functionName.
	...
	// Visit a parse tree produced by MiniQLParser#binaryArithExpr.
	VisitBinaryArithExpr(ctx *BinaryArithExprContext) interface{}

	// Visit a parse tree produced by MiniQLParser#qualifiedColumnRef.
	VisitQualifiedColumnRef(ctx *QualifiedColumnRefContext) interface{}
	...
	// Visit a parse tree produced by MiniQLParser#logicalExpr.
	VisitLogicalExpr(ctx *LogicalExprContext) interface{}

	// Visit a parse tree produced by MiniQLParser#nestedExpr.
	VisitNestedExpr(ctx *NestedExprContext) interface{}

	// Visit a parse tree produced by MiniQLParser#comparisonExpr.
